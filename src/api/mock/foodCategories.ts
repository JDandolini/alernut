export const foodCategories = [
    {
        id: "1", image: require("../../../assets/cereals.png"), color: "#FFCF00", name: "Cereais, pães e tubérculos", items: [
            { id: "1a", name: "Arroz", allergens: ["soja", "Contém glúten"], imageURL: "" },
            { id: "2a", name: "Trigo", allergens: ["Contém glúten", "soja", "cevada", "centeio", "aveia"], 
            imageURL:"" },
            { id: "3a", name: "Aveia", allergens: ["Contém glúten", "trigo", "cevada", "centeio"] },
            { id: "4a", name: "Milho", allergens: ["soja", "girassol"] },
            { id: "5a", name: "Cevada", allergens: ["Contém glúten", "cevada"] },
            { id: "6a", name: "Quinoa"},
            { id: "7a", name: "Centeio", allergens: ["Contém glúten", "centeio"] },
            { id: "8a", name: "Pão de trigo integral", allergens: ["Contém glúten", "Trigo"] },
            { id: "9a", name: "Pão branco", allergens: ["Contém glúten", "trigo","leite","soja","castanha do pará","castanha de caju","amendoim","centeio","cevada","aveia","ovo"] },
        ]
    },
    {
    ...
    { id: "5",image: require("../../../assets/oils.png"), color: "#FFD670", name: "Óleos e gorduras", items:[
        ...
        { id: "2a", name: "Óleo de soja", allergens: ["soja"] },
        { id: "3a", name: "Óleo de Canola", allergens: ["soja"] },
        { id: "4a", name: "Óleo de girassol", allergens: ["soja"] },
